...
/// filtering and paging the same area report nothing. An exploration is
/// checked until it ends, and one that found places reloads the results from
/// the top. A Deepen request keeps its idempotency key until the server
/// accepts it, so retrying a failed one cannot start a second exploration.
