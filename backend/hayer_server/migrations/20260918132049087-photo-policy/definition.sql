...
CREATE TABLE "hayer_cache_settings" (
    ...
    "discoveryUserHarvestsPerHour" bigint NOT NULL DEFAULT 3,
...
-- hayer_poi_issue_values_valid was missing from fresh definitions after
-- 20260909025500100-poi-issue-reports; upgraded databases already have it.
